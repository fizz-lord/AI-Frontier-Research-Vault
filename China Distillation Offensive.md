...
created: 2026-07-17
tags: [model-extraction, distillation, geopolitics, open-weight]
---
...
- Chinese open-weight models accounted for 41% of Hugging Face downloads, assaulting the economic model of frontier labs.
- Satya Nadella publicly called anti-distillation positions hypocritical.
- Frontier coding agents confirmed as standard tools in state-sponsored intrusion kits.

## Source
- New York Post, Security Affairs, Reuters, TechCrunch

## Related
- [[AI Security Index]]
- [[Alibaba Distillation Campaign]]
